      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48 }}>
        <div style={colStyle}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
            <a href="https://github.com" style={{ width: 32, height: 32, borderRadius: 'var(--cv-radius-sm)', border: '1px solid var(--cv-border)', background: 'var(--cv-surface)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--cv-text-muted)', textDecoration: 'none' }}>
        ...
        <div style={colStyle}>
          ...
          <a href="#" style={linkStyle}>Examples</a>
        ...
        <div style={colStyle}>
          ...
          <a href="#" style={linkStyle}>Stack Frames</a>
          <a href="#" style={linkStyle}>The Heap</a>
          <a href="#" style={linkStyle}>Recursion</a>
        </div>
